...
[![CI](https://github.com/your-username/splat-slim/actions/workflows/ci.yml/badge.svg)](https://github.com/your-username/splat-slim/actions)
...
```bash
git clone https://github.com/your-username/splat-slim
cd splat-slim
pip install -e ".[dev]"
```
