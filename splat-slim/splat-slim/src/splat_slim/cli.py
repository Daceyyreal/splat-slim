...
Examples:
    splat-slim prune scene.ply out.ply --percentile 5
    splat-slim reduce-sh scene.ply out.ply --degree 2
    splat-slim run scene.ply out.ply --degree 3 --quant mixed
